...
class Doctrine implements IDatasource
{
    ...
    public function __construct(Conn $connection, $config = null)
    {
        ...
        if (isset($config))
        {
            ...
            {
                $this->addTableMapping($name, $entity['tableName'], $entity['primaryKey'], $entity['nameCol'], isset($entity['sequenceName']) ? $entity['sequenceName'] : null);
            }
        }
    }
     ...
     * @return void
     */
    public function addTableMapping($entityName, $tableName, $pKeyCol, $nameCol, $sequenceName)
    {
    ...
    public function insert(Entity $entity, array $data)
    {
        ...
        {
            $sequenceName = $this->tableMappings[$name]['sequenceName'];
        }
        $insertId = $this->connection->lastInsertId($sequenceName);
